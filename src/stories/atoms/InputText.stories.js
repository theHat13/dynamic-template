  ...
  usageGuide.innerHTML = `
    ...
    <div class="space-y-6">
      <div>
        ...
        <pre class="bg-gray-100 p-3 rounded-md overflow-x-auto"><code class="text-sm text-gray-900">{% from "02-atoms-form/input-text.njk" import renderInputText %}</code></pre>
      </div>
